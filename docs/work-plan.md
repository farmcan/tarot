...
| Goal 4: Theme routing | Active | Decide whether themes are routes, a switcher, or separate static builds. | Choose routing model after Theme Lab feedback. | browser route smoke test |
...
| --- | --- | --- | --- |
| Theme routing | Next | Add public routes for MiaoTarot and ShipTarot or decide the route/switcher split from the strategy doc. | TBD |
...
| 4 | Social mode | Prototype a relationship two-person cat spread for sharing. | `site/src/domain/*`, `site/src/App.tsx` | browser share test |
